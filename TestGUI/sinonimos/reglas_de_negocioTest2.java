...
public class reglas_de_negocioTest2 {
    ...
    public void testAgregarsinonimo4() {
        ...
        Assert.assertEquals("No Detecto Agregado Valido", "No Excepcion",  ((MockOptionPane) rgFixture2.rg.getOptionPane()).getMessage());
    }
    /**
     * @see reglas_de_negocio#agregarsinonimo(String,String)
     */
    ...
    public void testAgregarsinonimo5() {
        ...
        Assert.assertEquals("No Detecto Agregado de Sinonimo Invalido", "Sinonimo Invalido",  ((MockOptionPane) rgFixture2.rg.getOptionPane()).getMessage());
    ...
    public void testEliminarsinonimo4()
    {
        ...
        Assert.assertEquals("No Detecto Diccionario Vacio", "Diccionario Vacio",  ((MockOptionPane) rgFixture2.rg.getOptionPane()).getMessage());
    }
