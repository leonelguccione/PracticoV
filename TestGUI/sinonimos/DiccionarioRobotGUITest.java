...
import sinonimos.DGTestInstance;
...
public class DiccionarioRobotGUITest
{
    ...
    public void testAgregarBusqueda_No_Vacio()
    {
        ...
        Assert.assertEquals("Agregar con Datos Inconsistentes", "Agregar con datos inconsistentes",
                            ((MockOptionPane) DGTestInstance.getDG().getOptionPane()).getMessage());
    }
    ...
    public void testBuscarClave_no_Vacio()
    {
        ...
        accionRobot(DGTestInstance.getPunto_Buscar());
        Assert.assertEquals("Busqueda Clave No Vacia", "Busqueda con datos inconsistentes",
                            ((MockOptionPane) DGTestInstance.getDG().getOptionPane()).getMessage());
    }
    ...
    public void testBuscarSinonimo_no_Vacio()
    {
        poneparametros("", "No Vacio", "Casa");
        accionRobot(DGTestInstance.getPunto_Buscar());
        Assert.assertEquals("Busqueda Sinonimo no Vacio", "Busqueda con datos inconsistentes",
                            ((MockOptionPane) DGTestInstance.getDG().getOptionPane()).getMessage());
    }
}
